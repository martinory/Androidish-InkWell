...
class InkResponse extends StatefulWidget {
  ...
  /// If the splash should cover the whole radius.
  /// If set to false gives 50 % of the radius.
  /// Default is set to false.
  final bool coverWholeRadius;
...
class _InkResponseState<T extends InkResponse> extends State<T> with AutomaticKeepAliveClientMixin<T> {
  ...
  TapDownDetails _currentTapDownDetails;
  ...
  void _handleTapDown(TapDownDetails details) {
    _currentTapDownDetails = details;
  ...
  void _showSplash() {
    ...
    Future<void>.delayed(_kSplashDurationUntilCanceled, () => updateHighlight(_HighlightType.pressed, value: false));
  }
